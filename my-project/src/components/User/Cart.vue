      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr v-for="item in items" :key="item.id">
            <th>
               <router-link :to="{ name: 'GoodDetail', params: {id: item.id} }" class="textelli">{{ item.id }}</router-link>
            </th>
            <td>
              <router-link :to="{ name: 'GoodDetail', params: {id: item.id} }">{{ goods[item.id].name }}</router-link>
            </td>
            <td>
